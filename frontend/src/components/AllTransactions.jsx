  ...
  return (
    <div className="w-full bg-gray-950/50 md:px-8 p-5 text-gray-400 border-1 border-white/10 rounded-2xl ">
      <div className='md:text-2xl text-white font-semibold flex w-full justify-between'>
        ...
        <input type="text" name="" id="" className='rounded-3xl border-2 border-white/10 px-2 md:px-5  md:text-base text-xs font-normal h-8 md:h-10' placeholder='Search' />
            ...
            <TableBody>
              {
                transactions.map((transaction, idx) => (
                  ...
                  <TableRow key={transaction.id} className="text-xs md:text-base">
                    <TableCell className="font-medium">{new Date(transaction.date).toLocaleDateString("en-IN")}</TableCell>
