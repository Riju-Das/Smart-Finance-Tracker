...
interface TransitionConfig extends Omit<Transition, "repeat" | "repeatType"> {
  repeat: number;
...
export const LoaderOne: React.FC = () => {
  const transition = (x: number): TransitionConfig => {
    return {
      duration: 1,
      repeat: Infinity,
      repeatType: "loop",
...
export const LoaderFive: React.FC<LoaderFiveProps> = ({ text }) => {
  return (
